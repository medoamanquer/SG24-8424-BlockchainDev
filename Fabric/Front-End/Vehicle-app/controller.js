...
let peerAddress=config.peerAddress;

let chainCodeName=config.chainCodeName;
let ordererAddress =config.ordererAddress
...
return{
	...
	addVehicle: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // Create Vehicle  - requires 6 args, ID, Model, Coluor, timestamp ,Location , Owner 
		    // send proposal to endorser
		    const request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'newchaincode',
		        fcn: 'recordVehicle',
	...
	getVehicle: function(req, res){
		...
		// setup the fabric network
		console.log(channelName +" "+peerAddress +" "+chainCodeName );
		var channel = fabric_client.newChannel(channelName);
		var peer = fabric_client.newPeer(peerAddress);
		channel.addPeer(peer);
