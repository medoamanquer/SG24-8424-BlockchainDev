...
printf "\n\nCreating Vehicle 2\n"
 curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "$class": "org.acme.vehicle_network.Vehicle", "vin": "81AB", "trim": "Economy","interior": "Plastic", "extras": [],"make": "org.acme.vehicle_network.Manufacturer#awesomecars","modelType":"Duramo","colour":"Yellow","yearOfManufacture": 2018}' 'http://localhost:3000/api/org.acme.vehicle_network.Vehicle'

printf "\n\nCreating Vehicle 3\n"
 curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "$class": "org.acme.vehicle_network.Vehicle", "vin": "71QR", "trim": "Military","interior": "Steel", "extras": [],"make": "org.acme.vehicle_network.Manufacturer#awesomecars","modelType":"Panther","colour":"Yellow","yearOfManufacture": 2018}' 'http://localhost:3000/api/org.acme.vehicle_network.Vehicle'

printf "\n\nCreating Vehicle 4\n"
 curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "$class": "org.acme.vehicle_network.Vehicle", "vin": "89VP", "trim": "Luxury","interior": "Carbon", "extras": [],"make": "org.acme.vehicle_network.Manufacturer#awesomecars","modelType":"Luxor","colour":"Blue","yearOfManufacture": 2018}' 'http://localhost:3000/api/org.acme.vehicle_network.Vehicle'
