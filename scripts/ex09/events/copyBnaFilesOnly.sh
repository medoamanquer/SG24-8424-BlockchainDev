...
cp ~/Blockchain_Redbook_Application/scripts/ex09/package.json.ex09 ~/Blockchain_Redbook_Application/vehicle-manufacture-network/
...
cp ~/Blockchain_Redbook_Application/scripts/ex09/script.js.ex09 ~/Blockchain_Redbook_Application/vehicle-manufacture-network/lib/
...
cp ~/Blockchain_Redbook_Application/scripts/ex09/org.acme.vehicle_network.cto.ex09 ~/Blockchain_Redbook_Application/vehicle-manufacture-network/models/
