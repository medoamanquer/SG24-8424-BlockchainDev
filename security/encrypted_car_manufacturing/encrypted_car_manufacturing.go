...
/*
Extending the "enccc_example" to demonstrate the ability to encrypt/decrypt data
and perform programmatic logic over Hyperledger Fabric.

Customers are entitled to encrypt data and enroll their personal information; Regulator
should be able to use the verification key to verify the authenticiy of the data.
...
// Defining the asset data type



// Adding some programmatic rule that enforces any vehicleID must be starting with the string
// vehicle, and the customer with customer.
